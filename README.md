...
Review copmonent with used library  https://github.com/KaneCohen/modal-vanilla. Showing alert with selected rating value. Also if the user changes the state of the button by editing the source code, a standard alert with the message "Error" should be displayed after clicking the button.
